...
: Discussion with CP Caroline Creighton
=============================== Prelab ==================================

1. What data structure will you use to remember which cells have
already been added to the queue or not?

: A 2D array will be used in order to remember the cells that 
have already been added to the queue.

2. At what step of the BFS algorithm do you have to mark a cell as visited?

: The cell is marked as visited after the cell is evaulated,
...
: My mymaze.txt file has 2 paths from start to finish. The longer 
path goes all the way around on the left, while the shortest path 
cuts through the maze in the middle. When I ran my program on it,
